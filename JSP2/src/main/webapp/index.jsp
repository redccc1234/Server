...
<body>
	...
	<pre>
HTML : html,css,js 코드 작성 가능 + 정적페이지(미리 만들어둔 형태 그대로)

JSP : html,css,js,java,el,jstl 작성 가능 + 동적페이지(요청에 따라 응답화면 변함)
	</pre>
	...
	<form action="/el/test1">
		...
		문자열 입력 : <input type="number" name="intNum"><br>
		문자열 입력 : <input type="text" name="doubleNum"><br>
